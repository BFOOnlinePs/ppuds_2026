...
class ProgramTypeOfMeal extends Model implements TranslatableContract
{
    use LogsActivity;
    use Translatable;
    use softDeletes;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('clinic.table_prefix') . 'types_of_meals');
    }

    protected $translationForeignKey = 'type_of_meal_id';
