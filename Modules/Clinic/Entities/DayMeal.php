...
class DayMeal extends Model implements TranslatableContract
{
    use LogsActivity;
    use Translatable;
    use softDeletes;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('clinic.table_prefix') . 'day_meals');
    }
    ...
    {
        return $this->belongsTo(ProgramTypeOfMeal::class, 'type_of_meal_id');
    }
