...
class Edit extends Component implements HasForms
{
    ...
    public function mount($governorate)
    {
        $this->data = Governorate::find($governorate)->toArray();
    ...
    {
        $this->authorize('Governorate Update');
    ...
    public function render()
    {
        return view('geolocation::livewire.pages.country.edit')->layout(AppLayout::class, [
            'breadcrumbs' => [
                ...
                ['title' => __('Edit Governorate'), 'url' => route('governorates.add')],
            ]
        ]);
    }
}
