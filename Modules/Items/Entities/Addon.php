...
class Addon extends Model implements TranslatableContract, HasMedia
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('items.table_prefix') . 'addons');
    }
    ...
    public function addImage($file)
    {
        ...
        // مسح الصورة السابقة
        $this->clearMediaCollection('addon');
    ...
    {
        return $this->getFirstMediaUrl('addon');
    }

    public function addonOptions(): HasMany
    {
