...
use Modules\Content\Entities\Page; // استخدام موديل الصفحة
...
class Edit extends Component implements HasForms
{
    ...
    {
        $this->record = Page::where('slug', $slug)->firstOrFail();
    ...
    public function render()
    {
        return view('content::livewire.pages.page.add')->layout(AppLayout::class, [
            'breadcrumbs' => [
                ...
                ['title' => __('Edit Page'), 'url' => route('pages.edit', $this->record->slug)],
            ]
        ]);
    }
}
