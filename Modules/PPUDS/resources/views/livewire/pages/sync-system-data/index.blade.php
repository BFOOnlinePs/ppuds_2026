<div>
    @php($canSyncSystemData = auth()->user()?->can('Sync System Data Sync') ?? false)
    ...
    <div class="mb-4 flex flex-wrap items-center gap-4">
        ...
        <div>
            ...
            <input type="text" wire:model="academicYear" @disabled($useUniversitySettings || ! $canSyncSystemData)
        ...
        <div>
            ...
            <input type="text" wire:model="semester" @disabled($useUniversitySettings || ! $canSyncSystemData)
                   class="mt-1 block w-40 rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 sm:text-sm">
        </div>
