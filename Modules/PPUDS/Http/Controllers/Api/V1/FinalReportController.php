...
class FinalReportController extends Controller
{
     ...
     * @OA\Property(property="final_file", type="string", format="binary", description="مرفق اختياري: jpeg, png, jpg, pdf, docx, zip أو rar بحد أقصى 10 ميجابايت. رفع ملف جديد يستبدل السابق. عند استخدام multipart تُرسل الجداول بصيغة الأقواس مثل tasks[0][task_name]."),
