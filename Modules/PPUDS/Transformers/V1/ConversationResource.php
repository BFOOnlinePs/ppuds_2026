...
class ConversationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'name'              => $this->name ?: $this->getPartnerName($authId),

            'unread_count'      => $this->getUnreadCount($authId),

            'last_active_at'    => $this->whenLoaded('participants', fn() =>
                                        $this->participants->firstWhere('participantable_id', $authId)?->last_active_at
                                   ),
    ...
    {
        return $this->whenLoaded('participants', fn() =>
            $this->participants->firstWhere('participantable_id', '!=', $authId)?->participantable?->name
        );
    }
