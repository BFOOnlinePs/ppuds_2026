...
<html lang="{{ app()->getLocale() }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <script src="{{ asset('assets/dashboard/admin-theme/js/perfect-scrollbar.min.js') }}"></script>
    <script defer src="{{ asset('assets/dashboard/admin-theme/js/popper.min.js') }}"></script>
    <script defer src="{{ asset('assets/dashboard/admin-theme/js/tippy-bundle.umd.min.js') }}"></script>
    <script defer src="{{ asset('assets/dashboard/admin-theme/js/sweetalert.min.js') }}"></script>
...
<body
    x-init="$store.app.rtlClass = '{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}'; $store.app.setRTLLayout()"
    x-data="main"
    class="relative antialiased overflow-x-hidden font-nunito text-sm font-normal antialiased"
...
<!-- screen loader -->
<div class="screen_loader animate__animated fixed inset-0 z-[60] grid place-content-center bg-[#fafafa] dark:bg-[#e70915]">
    <svg class="text-primary" width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <path
...
<div class="main-container min-h-screen flex text-black dark:text-white-dark" :class="[$store.app.navbar]">
...
<script src="{{ asset('assets/dashboard/admin-theme/js/alpine-collaspe.min.js') }}"></script>
{{--<script src="{{ asset('assets/dashboard/admin-theme/js/alpine-persist.min.js') }}"></script>--}}
{{--<script defer src="{{ asset('assets/dashboard/admin-theme/js/alpine-ui.min.js') }}"></script>--}}
{{--<script defer src="{{ asset('assets/dashboard/admin-theme/js/alpine-focus.min.js') }}"></script>--}}
{{--<script defer src="{{ asset('assets/dashboard/admin-theme/js/alpine.min.js') }}"></script>--}}
<script src="{{ asset('assets/dashboard/admin-theme/js/custom.js') }}"></script>
{{--<script defer src="{{ asset('assets/dashboard/admin-theme/js/apexcharts.js') }}"></script>--}}

<script src="{{ asset('assets/dashboard/admin-theme/js/file-upload-with-preview.iife.js') }}"></script>

<script>
    document.addEventListener('alpine:init', () => {

        Alpine.store('app').setRTLLayout('ltr');
        Alpine.store('app').locale = '{{ app()->getLocale() }}';
...
<livewire:core::global-notification-listener />
