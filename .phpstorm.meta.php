...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/BFound/eccomerce/eccomerce/public/storage' => 'string',
            ...
            'fortify.paths.registration' => 'NULL',
            ...
            'fortify.redirects.registration' => 'NULL',
            ...
            'modules.registration.translations' => 'boolean',
            'modules.registration.files' => 'string',
            ...
            'blade-solar-icons.prefix' => 'string',
            'blade-solar-icons.fallback' => 'string',
            'blade-solar-icons.class' => 'string',
            'blade-solar-icons.attributes' => 'array',
...
'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/BFound/eccomerce/eccomerce/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'fortify.paths.password.confirm','fortify.paths.password.confirmation','fortify.paths.registration','fortify.paths.verification.notice','fortify.paths.verification.verify',
...
'fortify.redirects.login','fortify.redirects.logout','fortify.redirects.password-confirmation','fortify.redirects.registration','fortify.redirects.email-verification',
'fortify.redirects.password-reset','fortify.features','jetstream.stack','jetstream.middleware','jetstream.features',
'jetstream.profile_photo_disk','jetstream.auth_session','jetstream.guard','laravellocalization.supportedLocales.en.name','laravellocalization.supportedLocales.en.script',
'laravellocalization.supportedLocales.en.native','laravellocalization.supportedLocales.en.regional','laravellocalization.supportedLocales.ar.name','laravellocalization.supportedLocales.ar.script','laravellocalization.supportedLocales.ar.native',
'laravellocalization.supportedLocales.ar.regional','laravellocalization.useAcceptLanguageHeader','laravellocalization.hideDefaultLocaleInURL','laravellocalization.localesOrder','laravellocalization.localesMapping',
'laravellocalization.utf8suffix','laravellocalization.urlsIgnored','laravellocalization.httpMethodsIgnored','logging.default','logging.deprecations.channel',
...
'media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','modules.namespace','modules.stubs.enabled',
...
'modules.composer.author.name','modules.composer.author.email','modules.composer.composer-output','modules.registration.translations','modules.registration.files',
'modules.activators.file.class','modules.activators.file.statuses-file','modules.activator','modules-livewire.namespace','modules-livewire.view',
...
'blade-solar-icons.prefix','blade-solar-icons.fallback','blade-solar-icons.class','blade-solar-icons.attributes','livewire.class_namespace',
...
'filament.exports.download','filament.imports.failed-rows.download','login','login.store','logout',
'password.request','password.reset','password.email','password.update','registration',
'registration.store','user-profile-information.update','user-password.update','password.confirm','password.confirmation',
...
'profile.show','sanctum.csrf-cookie','livewire.update',
'livewire.upload-file','livewire.preview-file','api.core.index',
'api.core.store','api.core.show','api.core.update','api.core.destroy','home',
'settings','storage.local',);
        registerArgumentsSet('views',
'api.api-token-manager','api.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.registration','auth.reset-password','auth.two-factor-challenge','auth.verify-email','components.action-message',
...
'components.banner','components.breadcrumbs','components.button','components.checkbox','components.confirmation-modal',
...
'components.switchable-team','components.validation-errors','components.welcome','core::components.button.primary','core::components.layouts.master',
'core::filament.forms.components.file-upload','core::filament.forms.components.text-input','core::filament.forms.components.textarea','core::index','core::livewire.pages.home.index',
'core::livewire.pages.settings.index','dashboard','emails.team-invitation','filament-forms::component-container','filament-forms::components.actions',
...
'layouts.app','layouts.guest','layouts.header','layouts.sidebar','navigation-menu',
'partials.head','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form','profile.show',
'profile.two-factor-authentication-form','profile.update-password-form','profile.update-profile-information-form','terms','vendor.filament-forms.component-container',
'vendor.filament-forms.components.actions','vendor.filament-forms.components.actions.action-container','vendor.filament-forms.components.builder','vendor.filament-forms.components.builder.block-picker','vendor.filament-forms.components.checkbox',
'vendor.filament-forms.components.checkbox-list','vendor.filament-forms.components.color-picker','vendor.filament-forms.components.date-time-picker','vendor.filament-forms.components.field-wrapper.error-message','vendor.filament-forms.components.field-wrapper.helper-text',
'vendor.filament-forms.components.field-wrapper.hint','vendor.filament-forms.components.field-wrapper.index','vendor.filament-forms.components.field-wrapper.label','vendor.filament-forms.components.fieldset','vendor.filament-forms.components.file-upload',
'vendor.filament-forms.components.grid','vendor.filament-forms.components.group','vendor.filament-forms.components.hidden','vendor.filament-forms.components.key-value','vendor.filament-forms.components.livewire',
'vendor.filament-forms.components.markdown-editor','vendor.filament-forms.components.placeholder','vendor.filament-forms.components.radio','vendor.filament-forms.components.repeater.index','vendor.filament-forms.components.repeater.simple',
'vendor.filament-forms.components.rich-editor','vendor.filament-forms.components.rich-editor.toolbar.button','vendor.filament-forms.components.rich-editor.toolbar.group','vendor.filament-forms.components.section','vendor.filament-forms.components.select',
'vendor.filament-forms.components.split','vendor.filament-forms.components.tabs','vendor.filament-forms.components.tabs.tab','vendor.filament-forms.components.tags-input','vendor.filament-forms.components.text-input',
'vendor.filament-forms.components.textarea','vendor.filament-forms.components.toggle','vendor.filament-forms.components.toggle-buttons.grouped','vendor.filament-forms.components.toggle-buttons.index','vendor.filament-forms.components.wizard',
'vendor.filament-forms.components.wizard.step','vendor.filament.assets','vendor.filament.components.actions','vendor.filament.components.avatar','vendor.filament.components.badge',
'vendor.filament.components.breadcrumbs','vendor.filament.components.button.group','vendor.filament.components.button.index','vendor.filament.components.card','vendor.filament.components.dropdown.header',
'vendor.filament.components.dropdown.index','vendor.filament.components.dropdown.list.index','vendor.filament.components.dropdown.list.item','vendor.filament.components.fieldset','vendor.filament.components.grid.column',
'vendor.filament.components.grid.index','vendor.filament.components.icon','vendor.filament.components.icon-button','vendor.filament.components.input.checkbox','vendor.filament.components.input.index',
'vendor.filament.components.input.radio','vendor.filament.components.input.select','vendor.filament.components.input.wrapper','vendor.filament.components.link','vendor.filament.components.loading-indicator',
'vendor.filament.components.loading-section','vendor.filament.components.modal.description','vendor.filament.components.modal.heading','vendor.filament.components.modal.index','vendor.filament.components.pagination.index',
'vendor.filament.components.pagination.item','vendor.filament.components.section.description','vendor.filament.components.section.heading','vendor.filament.components.section.index','vendor.filament.components.tabs.index',
'vendor.filament.components.tabs.item','welcome','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament-panels::pages.auth.email-verification.email-verification-prompt','filament-panels::pages.auth.login','filament-panels::pages.auth.password-reset.request-password-reset','filament-panels::pages.auth.password-reset.reset-password','filament-panels::pages.auth.registration',
'filament-panels::pages.dashboard','filament-panels::pages.tenancy.edit-tenant-profile','filament-panels::pages.tenancy.registration-tenant','filament-panels::resources.pages.create-record','filament-panels::resources.pages.edit-record',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','translatable::validation.translatableUnique',
'translatable::validation.translatableExist','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading','filament-actions::associate.single.modal.fields.record_id.label','filament-actions::associate.single.modal.actions.associate.label',
...
'filament-actions::registration.0','filament-actions::dashboard.0','filament-actions::edit-tenant-profile.0','filament-actions::create-record.0','filament-actions::edit-record.0',
...
'filament-panels::email-verification-prompt.0','filament-panels::login.0','filament-panels::request-password-reset.0','filament-panels::reset-password.0','filament-panels::registration.0',
...
'filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','core::ar.0',);
